...
import { Coins, Gift, Loader2, LogOut, ShieldCheck, Zap } from "lucide-react";
...
function AuthenticatedHeaderRight() {
  ...
  const isStaff = role === "admin" || isAdmin === true;
    ...
    <div className="flex items-center gap-3">
      {isStaff && (
        <Link to="/staff" data-ocid="nav.staff.link">
          <Button
            size="sm"
            className="font-black tracking-widest text-xs px-4 border-none"
            style={{
              background:
      ...
      >
        ...
        <div className="ml-auto flex items-center gap-3">
          {isInitializing ? (
            ...
            <>
              <Link to="/auth" data-ocid="auth.login.link">
                <Button
                  variant="ghost"
                  size="sm"
              ...
              <Link to="/auth" data-ocid="auth.signup.link">
                <Button
                  size="sm"
